...
This library contains utilities for working with file formats related to
GNU gettext. Currently, it supports reading MO files with original and
translated strings.

The test suite includes property-driven tests written with Expecto and FsCheck to 
try and exercise many different file formulations.
...
GitHub Actions |
:---: |
[![GitHub Actions](https://github.com/enovales/FsGettextUtils/workflows/Build%20master/badge.svg)](https://github.com/enovales/FsGettextUtils/actions?query=branch%3Amaster) |
[![Build History](https://buildstats.info/github/chart/enovales/FsGettextUtils)](https://github.com/enovales/FsGettextUtils/actions?query=branch%3Amaster) |

## NuGet 

Package | Stable | Prerelease
--- | --- | ---
FsGettextUtils | [![NuGet Badge](https://buildstats.info/nuget/FsGettextUtils)](https://www.nuget.org/packages/FsGettextUtils/) | [![NuGet Badge](https://buildstats.info/nuget/FsGettextUtils?includePreReleases=true)](https://www.nuget.org/packages/FsGettextUtils/)
